...
switch(trafficLight) {
    ...
    case "yellow":
        ...
        break;
    case "red":
        alert("Stop, if people are looking!");
        break;
    case "blinking yellow":
        alert("Caution!");
        break;
    case "blinking red":
        alert("Stop, then go when it's clear");
        break;
    default:
        alert("Drive Faster!!");
        break;
...
//  if the box is checked + 5

// 2) https://mdn.github.io/learning-area/javascript/building-blocks/simple-else-if.html

//   a case for each type of weather that returns the string.

// 3) https://mdn.github.io/learning-area/javascript/building-blocks/simple-ternary.html

//  if white is selected turn background white and font black
//  if black is selected turn background black and font white