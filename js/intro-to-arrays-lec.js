...
var favoriteFoods = ["chicken", "pizza", "hamburger", "venison"];
...
for (var a = 0; a < shapes.length; a++) {
    ...
    if (shapes[a] === "circle"){
        console.log(a);
        alert(shapes[a] + " is my favorite shape!");
    }
        }
    
// TODO: What happens if we change var i = 1? or var i = 2;

for (var b = 1; b < shapes.length; b++) {
    console.log(shapes[b])
}


// TODO: What are benefits of using loops to iterate?

// it's a lot less code and easier.

// TODO: How does the loop know when to stop iterating?

//you tell it in the condition

// TODO: Using a for loop, iterate through the instructors array and console.log each instructor

for (var c = 0; c < instructors.length; c++) {
    console.log(instructors[c])
}
...
for (var e = 0; e < favoriteFoods.length; e++) {
    console.log(favoriteFoods[e])
}
...
for (var c = 0; c < instructors.length; c++) {
    ...
    if (instructors[c] === "sophie" || instructors[c] === "vivian" || instructors[c] === "david"){
        alert("Hey, I know " + instructors[c]);
} else {
